document.addEventListener("DOMContentLoaded", function() {
    ...
    // Fetch transaction details when the page reloads
    function fetchTransactionDetails() {
        ...
        .then(data => {
            ...
            // Update the transaction information in the frontend based on the data received from the backend
    ...
    function updateTransactionDetails(transactions) {
        ...
        transactionDetailsContainer.innerHTML = ''; // Clear existing content
        ...
        transactions.forEach(transaction => {
            ...
            // Add transaction details to the element
            transactionElement.innerHTML = `
                <p><strong>Transaction ID:</strong> <span>${transaction._id}</span></p>
                ...
                <p><strong>Description:</strong> <span>${transaction.description || 'N/A'}</span></p>
                <p>__________________________________________________________</p>
                <!-- Include more transaction details as needed -->
            `;
    
            // Append the transaction element to the container
            transactionDetailsContainer.appendChild(transactionElement);
        });
    }
